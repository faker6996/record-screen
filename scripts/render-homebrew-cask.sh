...
TEMPLATE_PATH="$ROOT_DIR/packaging/homebrew/Casks/record-screen.rb.template"
OUTPUT_PATH="${1:-$ROOT_DIR/packaging/homebrew/Casks/record-screen.rb}"
...
Optional:
  ...
  scripts/render-homebrew-cask.sh /path/to/output/record-screen.rb
EOF
  exit 1
fi
